...
public class FormularioArticulo extends javax.swing.JFrame {
    ...
    private void btnGuardarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGuardarActionPerformed
        ...
        boolean resultado = this.idArticulo == 0 ?
        
        ArticuloDAO.guardar(nombre, precio):
        ArticuloDAO.editar(idArticulo, nombre, precio);
        
        if(resultado){
            JOptionPane.showMessageDialog(this, "El registro se guardó correctamente", "Registro guardado", JOptionPane.INFORMATION_MESSAGE);
                dispose();
            }else
                JOptionPane.showMessageDialog(this, "El registro se edito con exito", "Registro guardado", JOptionPane.INFORMATION_MESSAGE);
                dispose();
        } catch (Exception e) {
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                FormularioArticulo dialog = new FormularioArticulo(new javax.swing.JFrame(), true, 0);
